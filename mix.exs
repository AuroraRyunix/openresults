defmodule OpenResults.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind openresults", "esbuild openresults"],
      "assets.deploy": [
        "tailwind openresults --minify",
        "esbuild openresults --minify",
        "phx.digest"
      ],
